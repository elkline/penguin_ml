...
st.write("Upload your own file, or use the form below to make predictions") 
...
# Option 1: Import CSV file provided by user (if not, stop the app from running)
penguin_file = st.file_uploader("Select Your Local Penguins CSV")

# Option 2: Adding Streamlit functions to get user input
...
if penguin_file is not None:
   ...
   # This is only used to get the correct dummy variables, not to be used to make predictions
